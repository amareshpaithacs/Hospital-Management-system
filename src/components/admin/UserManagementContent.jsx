...
function UserManagementContent() {
  ...
  const handleSaveUser = () => {
    ...
    if (!form.email) formErrors.email = "Email address is required";
    ...
    <div className="container-fluid py-3 admin-content-container">
                ...
                <tr key={user.id}>
                  ...
                  <td>
                    <div className="d-flex align-items-center gap-1">
                      <button className="um-action-btn um-action-view" title="View user" onClick={() => openViewModal(user)}>
                        <BsEye size={15} />
                      </button>
                      <button className="um-action-btn um-action-edit" title="Edit user" onClick={() => openEditModal(user)}>
      ...
      <div className="um-stats-bar">
        <div className="um-stat-item">
          <span className="um-stat-label">Doctors</span>
          <span className="um-stat-value">{getRoleCount("Doctor")}</span>
        </div>
        <div className="um-stat-item">
          <span className="um-stat-label">Nurses</span>
          <span className="um-stat-value">{getRoleCount("Nurse")}</span>
        </div>
        <div className="um-stat-item">
          <span className="um-stat-label">Receptionists</span>
          <span className="um-stat-value">{getRoleCount("Receptionist")}</span>
        </div>
        <div className="um-stat-item">
          <span className="um-stat-label">Pharmacists</span>
          <span className="um-stat-value">{getRoleCount("Pharmacist")}</span>
        </div>
        <div className="um-stat-item">
          <span className="um-stat-label">Lab Technicians</span>
          <span className="um-stat-value">{getRoleCount("Lab Technician")}</span>
        </div>
        <div className="um-stat-item">
          <span className="um-stat-label">Admins</span>
          <span className="um-stat-value">{getRoleCount("Admin")}</span>
        </div>
      </div>
